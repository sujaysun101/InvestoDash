        ...
        <Card className="border-dashed border-border/70">
          <CardContent className="flex flex-col gap-3 py-10 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Add companies from the pipeline or connect your workspace so deals sync
              here. Demo mode includes sample deals once you sign in.
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent className="pt-6">
          {selectedDeals.length === 0 ? (
            <p className="text-center text-sm text-muted-foreground">
              Select at least one deal above to populate the comparison table.
            </p>
          ) : (
            <Table>
              <TableHeader>
